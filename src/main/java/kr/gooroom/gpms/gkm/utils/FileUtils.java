...
public class FileUtils {
	...
	/**
	 * Recursively traverses a folder and its subfolders to calculate the total size
	 * in bytes.
	 *
	 * @param directory
	...
	/**
	 * Determine the relative path between two files. Takes into account canonical
	 * paths, if possible.
	 *
	 * @param basePath
	 * @param path
	...
	/**
	 * Returns the File object by some parameter.
	 *
	 * @param parameter string
	 * @param aFolder   File object
	 * @param path      string
	 * @return File file
	 */
