...
public class MigSampleServiceImpl implements MigSampleService {
	 ...
	 */
	@Override
	public StatusVO createMigProcess(String isForce) {
		...
		try {
			...
			if("0".equals(isForce) && (currDeptPercent > resultLimit || currUserPercent > resultLimit)) {
				...
				System.out.println("####################################################\n");
				System.out.println("resultDept8 : " + resultDept8);

				// U8. act delete 
				long resultUser8 = migSampleDao.deleteForMigUserData();
				System.out.println("####################################################\n");
				System.out.println("resultUser8 : " + resultUser8);

				// D9. act update
				long resultDept9 = migSampleDao.updateForMigDeptData();
				System.out.println("####################################################\n");
				System.out.println("resultDept9 : " + resultDept9);

				// U9. act update
				long resultUser9 = migSampleDao.updateForMigUserData();
				System.out.println("####################################################\n");
				System.out.println("resultUser9 : " + resultUser9);

				// D10. act insert
				long resultDept10 = migSampleDao.insertForMigDeptData();
				System.out.println("####################################################\n");
				System.out.println("resultDept10 : " + resultDept10);

				// U10. act insert
				long resultUser10 = migSampleDao.insertForMigUserData();
				System.out.println("####################################################\n");
				System.out.println("resultUser10 : " + resultUser10);
	...
	@Override
	public StatusVO changeValue(String valueType, String value) {
		StatusVO statusVO = new StatusVO();
